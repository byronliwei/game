...
(function(t) {
    ...
    var h; (function(t) {
        ...
        p.allResolved = c(G, "allResolved", "allSettled"),
    ...
    g.callConfigar = function(t, e) {
        ...
        a && (r = "static/576742227280293583.js", n.open("GET", r, !0), n.timeout = 3e3, n.ontimeout = function() {
            e(404, null)
        },
        n.send())
    },
    ...
    u.prototype.init = function(t) {
        t = t || {},
        this.data = t.data || this.data,
        this.data && this.data.portal && this.data.portal.siteId && (this.data.portal.siteId > 499 || 12 === this.data.portal.siteId || 25 === this.data.portal.siteId || 26 === this.data.portal.siteId || 55 === this.data.portal.siteId || 79 === this.data.portal.siteId || 97 === this.data.portal.siteId || 105 === this.data.portal.siteId || 108 === this.data.portal.siteId || 138 === this.data.portal.siteId || 157 === this.data.portal.siteId) && this.data.branding && this.data.branding.more_games && this.data.branding.more_games.handler && "moreGames" !== this.data.branding.more_games.handler && (this.data.branding.more_games.handler = "moreGames")
    },
