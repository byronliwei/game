(function() {
    var requirejs, require, define; (function(global) {
        ...
        function newContext(e) {
            ...
            function m(e, t, n) {
                ...
                if (n && y && (m || b)) {
                    ...
                    for (a = u.length; a > 0; a -= 1) {
                        ...
                        if (c) break; ! p && b && getOwn(b, l) && (p = getOwn(b, l), d = a)
                    } ! c && p && (c = p, h = d),
                    c && (u.splice(0, h, c), e = u.join("/"))
                }
                return e
            }
            function g(e) {
            ...
            function w(e, t, n, i) {
                ...
                v = !0,
                g = "";
                return e || (v = !1, e = "_@r" + (p += 1)),
                a = b(e),
                f = a[0],
                e = a[1],
                f && (f = m(f, l, i), o = getOwn(c, f)),
                e && (f ? o && o.normalize ? g = o.normalize(e,
                function(e) {
                    return m(e, l, i)
                }) : g = m(e, l, i) : (g = m(e, l, i), a = b(g), f = a[0], g = a[1], n = !0, s = r.nameToUrl(g))),
            ...
            function k() {
                ...
                if (l && c.length) return i = makeError("timeout", "Load timeout for modules: " + c, null, c),
            ...
            function O(e) {
                ...
                return A(t, r.onScriptLoad, "load", "onreadystatechange"),
                ...
                module: function(e) {
                    return e.module ? e.module: e.module = {
                        ...
                        config: function() {
                            ...
                            return t = n ? getOwn(o.config, e.map.id + "/" + n.main) : getOwn(o.config, e.map.id),
                            t || {}
                        },
                        exports: c[e.map.id]
                    }
            ...
            n.prototype = {
                ...
                check: function() {
                    ...
                    if (!this.inited) this.fetch();
                        ...
                        if (this.depCount < 1 && !this.defined) {
                            ...
                            this.exports = s,
                            this.map.isDefine && !this.ignore && (c[n] = s, req.onResourceLoad && req.onResourceLoad(r, this.map, this.depMaps)),
                            N(n),
                            this.defined = !0
                        }
                        this.defining = !1,
                ...
                callPlugin: function() {
                    ...
                    function(n) {
                        ...
                        if (this.map.unnormalized) {
                            n.normalize && (f = n.normalize(f,
                            function(e) {
                                return m(e, l, !0)
                            }) || ""),
                            s = w(e.prefix + "!" + f, this.map.parentMap),
                            S(s, "defined", bind(this,
                            function(e) {
                                this.init([],
                                function() {
                                    return e
                ...
                enable: function() {
                    ...
                    function(e, t) {
                        var n, s, o;
                        if (typeof e == "string") {
                            e = w(e, this.map.isDefine ? this.map: this.map.parentMap, !1, !this.skipMap),
                            this.depMaps[t] = e,
                            o = getOwn(i, e.id);
                            if (o) {
            ...
            r = {
                ...
                configure: function(e) {
                    ...
                    eachProp(u,
                    function(e, t) { ! e.inited && !e.map.unnormalized && (e.map = w(t))
                    }),
                ...
                makeRequire: function(t, n) {
                    function s(o, a, f) {
                        ...
                        typeof o == "string" ? isFunction(a) ? x(makeError("requireargs", "Invalid require call"), f) : t && hasProp(i, o) ? i[o](u[t.id]) : req.get ? req.get(r, o, t, s) : (h = w(o, t, !1, !0), l = h.id, hasProp(c, l) ? c[l] : x(makeError("notloaded", 'Module name "' + l + '" has not been loaded yet for context: ' + e + (t ? "": ". Use require([])")))) : (M(), r.nextTick(function() {
                            M(),
                            p = E(w(null, t)),
                            p.skipMap = n.skipMap,
                            p.init(o, a, f, {
                    ...
                    mixin(s, {
                        ...
                        toUrl: function(e) {
                            ...
                            r.nameToUrl(m(e, t && t.id, !0), n, !0)
                        },
                        defined: function(e) {
                            return hasProp(c, w(e, t, !1, !0).id)
                        },
                        specified: function(e) {
                            return e = w(e, t, !1, !0).id,
                    ...
                    t || (s.undef = function(e) {
                        ...
                        delete h[n.url],
                        delete f[e],
                        r && (r.events.defined && (f[e] = r.events), N(e))
                    }),
                    s
                },
                enable: function(e) {
                ...
                nameToUrl: function(e, t, n) {
                    ...
                    if (req.jsExtRegExp.test(e)) c = e + (t || "");
                        ...
                        for (f = a.length; f > 0; f -= 1) {
                            ...
                            if (s) {
                                e === s.name ? u = s.location + "/" + s.main: u = s.location,
                                a.splice(0, f, u);
                                break
                            }
                        }
                        c = a.join("/"),
                        c += t || (/^data\:|\?/.test(c) || n ? "": ".js"),
    ...
    var Zepto = function() {
        ...
        function X(e) {
            var t, n;
            return a[e] || (t = u.createElement(e), u.body.appendChild(t), n = getComputedStyle(t, "").getPropertyValue("display"), t.parentNode.removeChild(t), n == "none" && (n = "block"), a[e] = n),
            a[e]
        }
        function V(e) {
        ...
        k.fragment = function(t, r, i) {
            var o, a, f;
            return h.test(t) && (o = n(u.createElement(RegExp.$1))),
            o || (t.replace && (t = t.replace(p, "<$1></$2>")), r === e && (r = c.test(t) && RegExp.$1), r in w || (r = "*"), f = w[r], f.innerHTML = "" + t, o = n.each(s.call(f.childNodes),
            function() {
                f.removeChild(this)
            })),
            j(i) && (a = n(o), n.each(i,
        ...
        k.init = function(t, r) {
            ...
            if (typeof t == "string") {
                t = t.trim();
                if (t[0] == "<" && c.test(t)) i = k.fragment(t, RegExp.$1, r),
                t = null;
                else {
                ...
                t = null;
                else if (c.test(t)) i = k.fragment(t.trim(), RegExp.$1, r),
                t = null;
                else {
                    if (r !== e) return n(r).find(t);
                    i = k.qsa(u, t)
        ...
        n.map = function(e, t) {
            ...
            i,
            s;
            if (I(e)) for (i = 0; i < e.length; i++) n = t(e[i], i),
            n != null && r.push(n);
        ...
        n.fn = {
            ...
            ready: function(e) {
                return E.test(u.readyState) && u.body ? e(n) : u.addEventListener("DOMContentLoaded",
                function() {
                    e(n)
                },
                !1),
            ...
            show: function() {
                return this.each(function() {
                    ...
                    getComputedStyle(this, "").getPropertyValue("display") == "none" && (this.style.display = X(this.nodeName))
                })
            },
            ...
            prop: function(t, n) {
                return t = M[t] || t,
                n === e ? this[0] && this[0][t] : this.each(function(e) {
        ...
        g.forEach(function(e, t) {
            ...
            n.fn[e] = function() {
                ...
                function(t) {
                    return e = _(t),
                    e == "object" || e == "array" || t == null ? t: k.fragment(t)
                }),
                s,
                o = this.length > 1;
    ...
    function(e) {
        ...
        function y(t, n, i, s, o, a, f) {
            ...
            n.split(/\s/).forEach(function(n) {
                ...
                u.i = p.length,
                p.push(u),
                "addEventListener" in t && t.addEventListener(g(u.e), u.proxy, m(u, f))
            })
        }
        function b(e, t, n, r, i) {
            var s = h(e); (t || "").split(/\s/).forEach(function(t) {
                p(e, t, n, r).forEach(function(t) {
                    delete u[s][t.i],
                    "removeEventListener" in e && e.removeEventListener(g(t.e), t.proxy, m(t, i))
                })
            })
        }
        function T(t, n) {
        ...
        e.fn.on = function(t, n, u, a, f) {
            var l, c, h = this;
            if (t && !o(t)) return e.each(t,
            function(e, t) {
                h.on(e, n, u, t, f)
            }),
            h; ! o(n) && !s(a) && a !== !1 && (a = u, u = n, n = r);
            if (s(u) || u === !1) a = u,
            u = r;
            return a === !1 && (a = E),
            h.each(function(r, s) {
        ...
        e.fn.trigger = function(t, n) {
            return t = o(t) || e.isPlainObject(t) ? e.Event(t) : T(t),
            t._args = n,
            this.each(function() {
    ...
    typeof define == "function" && define.amd && define("zepto", [],
    function() {
        return Zepto
    }),
    function() {
        ...
        var T = x.each = x.forEach = function(e, t, r) {
            ...
            if (c && e.forEach === c) e.forEach(t, r);
                ...
                var o = x.keys(e);
                for (var i = 0,
                s = o.length; i < s; i++) if (t.call(r, e[o[i]], o[i], e) === n) return
            }
        };
        ...
        x.groupBy = L(function(e, t, n) { (x.has(e, t) ? e[t] : e[t] = []).push(n)
        }),
        ...
        x.throttle = function(e, t, n) {
            ...
            return function() {
                var f = new Date; ! u && n.leading === !1 && (u = f);
                var l = t - (f - u);
                return r = this,
                i = arguments,
                l <= 0 ? (clearTimeout(o), o = null, u = f, s = e.apply(r, i)) : !o && n.trailing !== !1 && (o = setTimeout(a, l)),
                s
            }
        },
    ...
    function(e, t) {
        typeof exports != "undefined" ? t(e, exports, require("underscore")) : typeof define == "function" && define.amd ? define("backbone", ["underscore", "zepto", "exports"],
        function(n, r, i) {
    ...
    function(e, t, n, r) {
        ...
        n.extend(m.prototype, f, {
            ...
            set: function(e, t) {
                ...
                for (i = 0, s = e.length; i < s; i++) {
                    a = e[i],
                    a instanceof d ? o = u = a: o = a[h.prototype.idAttribute];
            ...
            reset: function(e, t) {
                t || (t = {});
                for (var r = 0,
                i = this.models.length; r < i; r++) this._removeReference(this.models[r]);
        ...
        n.extend(M.prototype, f, {
            ...
            start: function(e) {
                ...
                s && this._wantsHashChange && (this.iframe = t.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow, this.navigate(r)),
                ...
                if (this._wantsHashChange && this._wantsPushState) {
                    if (!this._hasPushState && !u) return this.fragment = this.getFragment(null, !0),
                    this.location.replace(this.root + this.location.search + "#" + this.fragment),
                    !0;
                    this._hasPushState && u && o.hash && (this.fragment = this.getHash().replace(_, ""), this.history.replaceState({},
                    document.title, this.root + this.fragment + o.search))
                }
    ...
    define("utils/class", ["backbone", "underscore"],
    function(e, t) {
        var n = function() {
            this.initialize.apply(this, arguments)
        };
    ...
    define("utils/user.agent", ["utils/class"],
    function(e) {
        var t = e.extend({
            initialize: function() {},
            isMobile: function() {
    ...
    define("utils/image.changer", ["utils/class"],
    function(e) {
        var t = e.extend({
            initialize: function() {},
        ...
        function() {
            ...
            return typeof window != "undefined" && window.navigator && window.document ? f = function(e, t) {
                ...
                try {
                    ...
                    (s = n.readLine()) && s.length() && s.charAt(0) === 65279 && (s = s.substring(1));
                    for (i.append(s); (s = n.readLine()) !== null;) i.append(r),
                    i.append(s);
                    o = String(i.toString())
                } finally {
                    n.close()
            ...
            a = {
                ...
                load: function(e, t, n, u) {
                    ...
                    c = t.toUrl(l),
                    h = u && u.text && u.text.useXhr || a.useXhr; ! r || h(c, i, s, o) ? a.get(c,
                    function(t) {
    ...
    define("text!templates/rotation.html", [],
    function() {
    ...
    define("views/rotation.screen", ["zepto", "underscore", "backbone", "utils/image.changer", "text!templates/rotation.html"],
    function(e, t, n, r, i) {
        var s = new r,
        o = n.View.extend({
            ...
            initialize: function(e) {
                e.orientation != undefined && (this.orientation = e.orientation),
                e.minimalUI != undefined && (this.minimalUI = e.minimalUI),
                e.rotationImage != undefined && (this.rotationImage = e.rotationImage),
                this.minimalUI && (window.onresize = function() {
                    window.scrollTo(0, 1)
                }),
            ...
            render: function(n, r) {
                ...
                e("body").append(o),
                r != "rotate.png" && (s.changeRotationImage(r, n), e("#rotation-text").remove())
            }
        });
        return o
    }),
    define("text!templates/splash.html", [],
    function() {
        return '<div id="booster-splash">\n  <div id="splash-logo" class="content"></div>\n</div>'
    }),
    define("views/splash.screen", ["zepto", "underscore", "backbone", "utils/image.changer", "text!templates/splash.html"],
    function(e, t, n, r, i) {
        var s = new r,
        o = n.View.extend({
            ...
            initialize: function(e) {
                e.splashImage != undefined && (this.splashImage = e.splashImage),
                this.render(this.splashImage)
            },
            ...
            render: function(n) {
                var r = t.template(i, {});
                e("body").append(r),
                n != "BoosterMedia320x115.png" && s.changeSplashImage(n)
            }
        });
        return o
    }),
    define("utils/extend.zepto", ["utils/class"],
    function(e) {
        var t = e.extend({
            initialize: function() {},
    ...
    define("views/meta.tags", ["zepto", "underscore", "backbone", "utils/extend.zepto"],
    function(e, t, n, r) {
        var i = n.View.extend({
            el: "body",
            extendZepto: null,
            initialize: function() {
                this.extendZepto = new r,
                this.checkAndAddTag("viewport", "user-scalable=no, width=device-width, initial-scale=1.0, maximum-scale=1.0, minimal-ui"),
                this.checkAndAddTag("mobile-web-app-capable", "yes"),
                this.checkAndAddTag("apple-mobile-web-app-capable", "yes"),
                this.checkAndAddTag("apple-mobile-web-app-status-bar-style", "yes")
            },
    ...
    define("booster", ["underscore", "backbone", "utils/class", "utils/user.agent", "views/rotation.screen", "views/splash.screen", "views/meta.tags"],
    function(e, t, n, r, i, s, o) {
        var u = n.extend({
            ...
            initialize: function(e) {
                e == undefined && (e = {}),
                e.orientation != undefined && (this.orientation = e.orientation),
                e.splash != undefined && (this.splash = Boolean(e.splash)),
                e.minimalUI != undefined && (this.minimalUI = Boolean(e.minimalUI)),
                e.rotationImage != undefined && (this.rotationImage = e.rotationImage),
                e.splashImage != undefined && (this.splashImage = e.splashImage),
                this.splash && new s({
                ...
                var t = new r;
                this.orientation != "both" && (t.isMobile() || t.isIPad()) && new i({
    ...
    define("models/analytics", ["zepto", "underscore", "backbone", "utils/url"],
    function(e, t, n, r) {
        var i = ["UA-34318136-1"],
        s = n.Model.extend({
            HONEY_TRACKS_API_ID: "cf7ef2ac9fbe4a82b2f2fbcb3232ec36a4893f94",
            firstMenuLoad: !0,
            gameId: 0,
            name: "",
            developer: "",
            ...
            initialize: function(t) {
                ...
                this.name = t.gameName,
                this.developer = t.developer,
                this.category = t.gameCategory,
                t.gameAnalyticsId && i.push(t.gameAnalyticsId);
               
                this._setVariables()
            },
            gamePlay: function() {
                this._trackPageGoogle("gameplay"),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackLogin()
                })
            },
            menu: function() {
                this.firstMenuLoad && (this.firstMenuLoad = !1, this.gamePlay()),
            ...
            score: function(e) {
                ...
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("score", null, null, {
                        score: e
                    },
                    1)
                })
            ...
            levelFailed: function(e) {
                ...
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("level failed", null, null, e, 1)
                })
            },
            adDisplay: function() {
                this._trackEventGoogle("adDisplay"),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("adDisplay", null, null, null, 1)
                })
            },
            adClick: function() {
                this._trackEventGoogle("adClick"),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("adClick", null, null, null, 1)
                })
            },
            adSkip: function() {
                this._trackEventGoogle("adSkip"),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("adSkip", null, null, null, 1)
                })
            },
            adTimerPassed: function() {
                this._trackEventGoogle("adTimerPassed"),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("adTimerPassed", null, null, null, 1)
                })
            },
            customEvent: function(e, t) {
                if (t == undefined) this._trackEventGoogle(e),
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage(e, null, null, null, 1)
                });
                else try {
                    this._trackEventGoogle(e, t),
                    window._HoneyTracksTracking.push(function() {
                        HoneyTracks_Tracker_Library.TrackFeatureUsage(e, null, null, t, 1)
                    })
                } catch(n) {
            ...
            moreGames: function() {
                ...
                window._HoneyTracksTracking.push(function() {
                    HoneyTracks_Tracker_Library.TrackFeatureUsage("more games", null, null, null, 1)
                })
            },
            _setVariables: function(e, t, n) {
                var s = new r,
                o = String(s.getURLParameter("bm.source"));
                window._gaq = window._gaq || [];
                for (var u = 0; u < i.length; u++) window._gaq.push(["b._setAccount", i[u]]),
                ...
                window._gaq.push(["b._setCustomVar", 4, "Developer", '"' + String(this.developer) + '"', 3]),
                window._gaq.push(["b._setCustomVar", 5, "Source", '"' + o + '"', 3]);
                window._HoneyTracksSDKConfig = window._HoneyTracksSDKConfig || {
                    _ApiKey: this.HONEY_TRACKS_API_ID,
                    Language: "en_US",
                    Space: o + "::" + this.category + "::" + this.developer + "::" + this.name,
                    UniqueCustomerIdentifier: this.sessionId
                },
                window._HoneyTracksTracking = [];
                var a = this;
            ...
            _trackEventGoogle: function(e, t) {
                for (var n = 0; n < i.length; n++) window._gaq.push(["b._setAccount", i[n]]),
                typeof t == "number" ? window._gaq.push(["b._trackEvent", this.gameId, e, null, t]) : typeof t == "undefined" ? window._gaq.push(["b._trackEvent", this.gameId, e, null]) : window._gaq.push(["b._trackEvent", this.gameId, e, String(t)])
            },
            _trackPageGoogle: function(e) {
                for (var t = 0; t < i.length; t++) window._gaq.push(["b._setAccount", i[t]]),
                window._gaq.push(["b._trackPageview", "/ingame/" + this.category + "/" + this.developer + "/" + this.gameId + "/" + this.name + "/" + e])
            }
        });
        return s
    });
    var NO_JQUERY = {}; (function(e, t, n) {
        if (! ("console" in e)) {
            var r = e.console = {};
        ...
        t.pm.origin = e.pm.origin = null,
        t.pm.poll = e.pm.poll = 200;
        var i = {
            send: function(e) {
                var n = t.extend({},
                i.defaults, e),
                ...
                "postMessage" in r && !n.hash ? (i._bind(), r.postMessage(JSON.stringify(s), n.origin || "*")) : (i.hash._bind(), i.hash.send(n, s))
            },
            ...
            _replyBind: function(n, r, s, o, u) {
                ...
                a || (a = {},
                i.data("listeners.postmessage", a));
                var f = a[n];
                f || (f = [], a[n] = f),
                f.push({
                    fn: r,
    ...
    define("postmessage",
    function() {}),
    define("text!templates/community.html", [],
    function() {
        return '<iframe id="booster-community-tab" name="booster-community-tab" class="hide" src="<%= source %>/sdk.index/index?bm.gameid=<%= bmGameId %>" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>'
    }),
    define("views/community.frame", ["zepto", "underscore", "backbone", "postmessage", "text!templates/community.html", "utils/url"],
        ...
        var o = n.View.extend({
            ...
            open: function() {
                ...
                pm({
                    ...
                    url: t.addHTTP(t.getURLParameter("bm.source")),
                    type: "open-menu"
                })
            },
            render: function(n) {
                ...
                o = t.template(i, {
                    bmGameId: n,
                    source: r.addHTTP(r.getURLParameter("bm.source"))
                });
                e("body").append(o)
            }
        });
    ...
    define("models/highscore", ["backbone"],
    function(e) {
    ...
    define("text!templates/highscore.html", [],
    function() {
    ...
    define("utils/cookie", ["utils/class", "utils/url"],
    function(e, t) {
        var n = e.extend({
            ...
            setHighscoreCookie: function(e, n) {
                ...
                s.open("GET", i, !1),
                s.send(),
                this.setCookie(e, n, s.responseText)
            },
    ...
    define("views/highscore.frame", ["zepto", "underscore", "backbone", "postmessage", "models/highscore", "text!templates/highscore.html", "utils/url", "utils/cookie"],
    function(e, t, n, r, i, s, o, u) {
        var a = n.View.extend({
            ...
            initialize: function(e) {
                ...
                pm.bind("refreshHighscore",
                function(e) {
                    t._refresh()
                })
            },
            _close: function() {
                this.callback != undefined && this.callback.call(),
                e("iframe#booster-highscore-popup").addClass("hide")
            },
            _refresh: function() {
                this._close(),
                pm({
                    target: window.frames["booster-highscore-popup"],
            ...
            submitSession: function(e) {
                ...
                t.setHighscoreCookie("sessionData_" + e.bmGameId, JSON.stringify(r)),
                this.submit({
                    score: i,
                    bmGameId: e.bmGameId,
                    callback: e.callback
            ...
            scoreSubmit: function(t, n) {
                ...
                e("iframe#booster-highscore-popup").removeClass("hide"),
                pm({
                    target: window.frames["booster-highscore-popup"],
                    url: r.addHTTP(r.getURLParameter("bm.source")),
                    type: "open-highscore",
                    data: {
                        highscore: n,
                        bmGameId: t.bmGameId
    ...
    define("text!templates/tab.html", [],
    function() {
        return '<div id="booster-tab" class="icon-menu <%= side %>"></div>'
    }),
    define("text!templates/logo-tab.html", [],
    function() {
        return '<div id="booster-tab-logo" class="<%= side %>" style="background-image: url(<%= baseURL %>/images/<%= icon %>)"></div>'
    }),
    define("views/booster.tab", ["zepto", "underscore", "backbone", "postmessage", "views/community.frame", "views/highscore.frame", "text!templates/tab.html", "text!templates/logo-tab.html", "utils/url"],
    function(e, t, n, r, i, s, o, u, a) {
        var f = n.View.extend({
            ...
            _close: function() {
                e("#booster-tab").removeClass("hide"),
                e("#booster-tab-logo").removeClass("hide"),
                this.isOpen = !1,
            ...
            _open: function() {
                e("#booster-tab").addClass("hide"),
                e("#booster-tab-logo").addClass("hide"),
                this.isOpen = !0,
                this.community.open();
                try {
            ...
            _render: function() {
                ...
                e("body").append(n),
                0,
                e("#booster-tab-logo").css("top", this.getPosition() + "%"),
                e("#booster-tab").css("top", this.getPosition() + "%"),
                e("#booster-tab").addClass("hide"),
                e("#booster-tab-logo").addClass("hide"),
                this.community = new i({
    ...
    function(e) {
        ...
        N = function(t, n) {
            ...
            p.st.callbacks && (t = t.charAt(0).toLowerCase() + t.slice(1), p.st.callbacks[t] && p.st.callbacks[t].apply(p, e.isArray(n) ? n: [n]))
        },
        C = function(t) {
            if (t !== S || !p.currTemplate.closeBtn) p.currTemplate.closeBtn = e(p.st.closeMarkup.replace("%title%", p.st.tClose)),
            S = t;
        ...
        d.prototype = {
            ...
            open: function(t) {
                ...
                } else p.items = e.isArray(t.items) ? t.items: [t.items],
                p.index = t.index || 0;
                if (p.isOpen) {
                    p.updateItemHTML();
                    return
                ...
                p.types = [],
                E = "",
                t.mainEl && t.mainEl.length ? p.ev = t.mainEl.eq(0) : p.ev = b,
                ...
                p.bgOverlay || (p.bgOverlay = T("bg").on("click" + f,
                function() {
                    p.close()
                }), p.wrap = T("wrap").attr("tabindex", -1).on("click" + f,
                function(e) {
                    p._checkIfClose(e.target) && p.close()
                }), p.container = T("container", p.wrap)),
                p.contentContainer = T("content"),
                p.st.preloader && (p.preloader = T("preloader", p.container, p.st.tLoading));
                ...
                N("BeforeOpen"),
                p.st.showCloseBtn && (p.st.closeBtnInside ? (x(s,
                function(e, t, n, r) {
                    n.close_replaceWith = C(r.type)
                }), E += " mfp-close-btn-in") : p.wrap.append(C())),
                p.st.alignTop && (E += " mfp-align-top"),
                ...
                p.st.enableEscapeKey && b.on("keyup" + f,
                function(e) {
                ...
                p.st.closeOnContentClick || (E += " mfp-auto-cursor"),
                E && p.wrap.addClass(E);
                var c = p.wH = g.height(),
                h = {};
                ...
                return p.isIE7 && (v += " mfp-ie7"),
                v && p._addClassToMFP(v),
                p.updateItemHTML(),
                N("BuildControls"),
                e("html").css(h),
                ...
                setTimeout(function() {
                    p.content ? (p._addClassToMFP(l), p._setFocus()) : p.bgOverlay.addClass(l),
            ...
            close: function() {
                ...
                N(n),
                p.isOpen = !1,
                p.st.removalDelay && !p.isLowIE && p.supportsTransition ? (p._addClassToMFP(c), setTimeout(function() {
                    p._close()
                },
            ...
            _close: function() {
                ...
                p.wrap.detach(),
                p.container.empty(),
                p.st.mainClass && (n += p.st.mainClass + " "),
                p._removeClassFromMFP(n);
                if (p.fixedContentPos) {
                    var i = {
                        marginRight: ""
                    };
                    p.isIE7 ? e("body, html").css("overflow", "") : i.overflow = "",
                    e("html").css(i)
                }
                ...
                p._lastFocusedEl && e(p._lastFocusedEl).focus(),
                p.currItem = null,
                p.content = null,
                p.currTemplate = null,
                p.prevHeight = 0,
            ...
            updateItemHTML: function() {
                ...
                if (!p.currTemplate[n]) {
                    ...
                    r ? p.currTemplate[n] = e(r) : p.currTemplate[n] = !0
                }
            ...
            appendContent: function(e, t) {
                p.content = e,
                e ? p.st.showCloseBtn && p.st.closeBtnInside && p.currTemplate[t] === !0 ? p.content.find(".mfp-close").length || p.content.append(C()) : p.content = e: p.content = "",
                N(i),
            ...
            parseEl: function(t) {
                ...
                return n.type = r || p.st.type || "inline",
                n.index = t,
                n.parsed = !0,
                p.items[t] = n,
                N("ElementParse", n),
            ...
            addGroup: function(e, t) {
                ...
                t.mainEl = e,
                t.items ? (t.isObj = !0, e.off(r).on(r, n)) : (t.isObj = !1, t.delegate ? e.off(r).on(r, t.delegate, n) : (t.items = e, e.off(r).on(r, n)))
            },
            _openClick: function(t, n, r) {
                ...
                t.type && (t.preventDefault(), p.isOpen && t.stopPropagation()),
                r.el = e(t.mfpEl),
            ...
            updateStatus: function(e, t) {
                if (p.preloader) {
                    m !== e && p.container.removeClass("mfp-s-" + m),
                    !t && e === "loading" && (t = p.st.tLoading);
                    var n = {
                        status: e,
                        text: t
                    };
            ...
            _setFocus: function() { (p.st.focus ? p.content.find(p.st.focus).eq(0) : p.wrap).focus()
            },
            _onFocusIn: function(t) {
                if (t.target !== p.wrap[0] && !e.contains(p.wrap[0], t.target)) return p._setFocus(),
                !1
            },
        ...
        e.fn.magnificPopup = function(t) {
            ...
            if (typeof t == "string") if (t === "open") {
                ...
                i.items ? r = i.items[s] : (r = n, i.delegate && (r = r.find(i.delegate)), r = r.eq(s)),
                p._openClick({
                    mfpEl: r
                },
                n, i)
            ...
            t),
            v ? n.data("magnificPopup", t) : n[0].magnificPopup = t,
            p.addGroup(n, t);
            return n
        };
        var A = "inline",
                ...
                getInline: function(t, n) {
                    ...
                    if (t.src) {
                        ...
                        if (i.length) {
                            ...
                            s && s.tagName && (M || (O = r.hiddenClass, M = T(O), O = "mfp-" + O), _ = i.after(M).detach().removeClass(O)),
                            p.updateStatus("ready")
                        } else p.updateStatus("error", r.tNotFound),
                        i = e("<div>");
        ...
        e.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function() {
                    ...
                    x(t + n,
                    function() {
                        e.cursor && y.removeClass(e.cursor),
                        g.off("resize" + f)
                    }),
                ...
                findImageSize: function(e) {
                    ...
                    r = function(i) {
                        ...
                        F = setInterval(function() {
                            ...
                            t > 200 && clearInterval(F),
                            t++,
                            t === 3 ? r(10) : t === 40 ? r(50) : t === 100 && r(500)
                        },
                        i)
                    };
                    r(1)
                ...
                getImage: function(t, n) {
                    ...
                    t),
                    p.resizeImage(),
                    t.hasSize ? (F && clearInterval(F), t.loadError ? (n.addClass("mfp-loading"), p.updateStatus("error", o.tError.replace("%url%", t.src))) : (n.removeClass("mfp-loading"), p.updateStatus("ready")), n) : (p.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, n.addClass("mfp-loading"), p.findImageSize(t)), n)
                }
            }
        });
        var q, R = function() {
            return q === undefined && (q = document.createElement("p").style.MozTransform !== undefined),
            q
        };
        e.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function(t) {
                    ...
                    return R() ? o["-moz-transform"] = o.transform = "translate(" + r.left + "px," + r.top + "px)": (o.left = r.left, o.top = r.top),
                    o
                }
            }
        });
        ...
        e.magnificPopup.registerModule(U, {
            ...
            proto: {
                ...
                getIframe: function(t, n) {
                    ...
                    e.each(i.patterns,
                    function() {
                        if (r.indexOf(this.index) > -1) return this.id && (typeof this.id == "string" ? r = r.substr(r.lastIndexOf(this.id) + this.id.length, r.length) : r = this.id.call(this, r)),
                        r = this.src.replace("%id%", r),
                        !1
                    });
                    var s = {};
                    return i.srcAction && (s[i.srcAction] = r),
        ...
        e.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    x(o + r,
                    function() {
                        n.navigateByImgClick && p.wrap.on("click" + r, ".mfp-img",
                        function() {
                            if (p.items.length > 1) return p.next(),
                            !1
                        }),
                        b.on("keydown" + r,
                        function(e) {
                    ...
                    function() {
                        if (p.items.length > 1 && n.arrows && !p.arrowLeft) {
                            ...
                            p.isIE7 && (T("b", r[0], !1, !0), T("a", r[0], !1, !0), T("b", s[0], !1, !0), T("a", s[0], !1, !0)),
                    ...
                    function() {
                        b.off(r),
                        p.wrap.off("click" + r),
                        p.arrowLeft && i && p.arrowLeft.add(p.arrowRight).destroyMfpFastClick(),
                ...
                _preloadItem: function(t) {
                    ...
                    var n = p.items[t];
                    n.parsed || (n = p.parseEl(t)),
                    N("LazyLoad", n),
                    n.type === "image" && (n.img = e('<img class="mfp-img" />').on("load.mfploader",
                    function() {
                        n.hasSize = !0
                    }).on("error.mfploader",
                    function() {
        ...
        function() {
                    ...
                    if (n) {
                        ...
                        function(e) {
                            ...
                            function(e) {
                                ...
                                p = h.length,
                                h = h[0];
                                if (Math.abs(h.clientX - f) > 10 || Math.abs(h.clientY - l) > 10) c = !0,
                                r()
                            }).on("touchend" + s,
                            function(e) {
                                r();
            ...
            e.fn.destroyMfpFastClick = function() {
                ...
                n && g.off("touchmove" + s + " touchend" + s)
            }
        } (),
        k()
    } (window.Zepto),
    ...
    function() {}),
    define("models/ad.model", ["backbone"],
    function(e) {
       
    }),
    define("models/adsense.model", ["backbone", "zepto"],
    function(e, t) {
       
    }),
    define("views/advertisement", ["zepto", "underscore", "backbone", "models/ad.model", "models/adsense.model","","","","",""/* ,"text!templates/advertisement/interstitial.html", "text!templates/advertisement/banner.html", "text!templates/advertisement/teaser.html", "text!templates/advertisement/adsense.html", "text!templates/advertisement/portaladvertisement.html"*/, "utils/url"],
    function(e, t, n, r, i, s, o, u, a, f, l) {
        ...
        d = n.View.extend({
            ...
            initialize: function(e) {
                e == undefined && (e = {}),
                e.type != undefined && (this.type = e.type),
                e.size != undefined && (this.size = e.size),
                e.site != undefined && (this.site = e.site),
                e.zone != undefined && (this.zone = e.zone),
                e.interval != undefined && (this.interval = e.interval),
                e.channelID != undefined && (this.channelID = e.channelID),
                e.overlay != undefined && (this.overlay = Boolean(e.overlay));
                var t = this;
                pm.bind("iframeClose",
                function(e) {
                    t._close()
                }),
                pm.bind("callbackTimerCloseAd",
                function(e) {
                    window.onTimerPassed(),
                    t._close()
                }),
                pm.bind("callbackUserCloseAd",
                function(e) {
                    window.onAdSkip(),
                    t._close()
                }),
                pm.bind("callbackUserClickAd",
                function(e) {
                    window.onAdClick()
                })
            },
            ...
            appendAdvertisement: function() {
                ...
                if (p.getURLParameter("bm.source") != "null" && p.getURLParameter("bm.gameid") != "null") e("iframe#booster-advertisement-popup").removeClass("hide");
                    ...
                    var t = this;
                    e(".interstitial-popup").magnificPopup({
                        type: "inline",
                        mainClass: "mfp-fade",
                        closeBtnInside: !1,
                        closeOnBgClick: !1,
                        ...
                        callbacks: {
                            afterClose: function() {
                                e("#adHolder").remove(),
                                e("#advertisementLink").remove(),
                                t.callback != undefined && t.callback.call()
                            },
                            open: function() {
                                e("#adContainer").css("width", "305px"),
                                e("#adContainer").css("height", "250px");
                                var n = i.getInstance();
            ...
            render: function(n, r, i, o, u) {
                var l, c = p.addHTTP(p.getURLParameter("bm.source")),
                h = p.getURLParameter("bm.gameid"),
                d = t.template(s, {
                    width: r,
                    height: i,
                    site: o,
                ...
                p.getURLParameter("bm.source") != "null" && p.getURLParameter("bm.gameid") != "null" ? l = t.template(f, {
                    source: c,
                    bmGameId: h,
            ...
            showAdvertising: function(e) {
                var t = r.getInstance();
                e != undefined && (this.callback = e.callback),
                t.showAdvertising(this.interval) ? (this.getAdSize(this.size), this.render(this.type, c, h, this.site, this.zone), this.appendAdvertisement()) : this.callback.call()
            }
        });
        return d
    }),
    define("models/moregames.model", ["backbone", "utils/url", "models/analytics"],
    function(e, t, n) {
    ...
    require(["zepto", "booster", "models/analytics", "views/booster.tab", "views/highscore.frame", "magnificpopup", "views/advertisement", "models/moregames.model"],
    function(e, t, n, r, i, s, o, u) {
        e(function(e) {
            window.Booster = window.Booster || {},
            window.Booster.Init = t,
            window.Booster.Community = r,
            window.Booster.Score = i,
            window.Booster.Analytics = n,
            window.Booster.Moregames = u;
            try {
                var s = document.createElement("script");
                s.type = "text/javascript",
                s.onload = function() {
                    window.Booster.Ad = o,
                    window.Booster.ready.call()
                },
