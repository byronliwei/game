		...
		function d() {
			...
			var c = new egret.TextField,
				c = utils.createTextLabel(c,
					7342404, "center", "START", 60, 0, 7342404, 3, 0, 0);
			this.addChild(c);
...
var __extends = this.__extends || function(b, d) {
	...
	GameUI = function(b) {
		function d() {
			...
			this.nameText = utils.createTextLabel(this.nameText, 16341428, "left", "COLOR SQUARE", 40, 0, 16341428, 2);
...
var __extends = this.__extends || function(b, d) {
	...
	OverPlan = function(b) {
		function d() {
			...
			var c = new egret.TextField,
				c = utils.createTextLabel(c, 16407734, "left", "GAME OVER", 40);
			this.addChild(c);
			...
			a.x = this.sprite.x;
			c = utils.createTextLabel(c,
				16777215, "left", ("SCORE:" + Settings.score).toString(), 24);
			c.x = this.sprite.x + 10;
			c.y = a.y + a.height + 30;
			this.addChild(c);
			this.rStartBtn = new DrawRectBtn(120, 50, 16777215, 10361701, "Restart", 20, 7342404);
			...
			this.shareBtn = new DrawRectBtn(120, 50, 16777215, 10361701, "Share", 20, 7342404);
		...
		d.prototype.shareBtn_begin = function(b) {
			...
			b.preventDefault();
			// LBShare.callShare();
			window.open(mobConfig.mainpage);//the hot games
			//this.shareBtn.down();
			//this.btnIsbool = 1
		};
