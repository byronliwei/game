...
com.funtomic.GameOps.getEventsStaticParams = function(events) {
	var data = { domain : com.funtomic.GameOps.domain, uuid : com.funtomic.GameOps.userID, platform : com.funtomic.GameOps.platform, install_date : com.funtomic.GameOps.localStorage.installDate, original_version : com.funtomic.GameOps.localStorage.originalVersion, partial_data : com.funtomic.GameOps.localStorage.partialData, is_in_kizi_app : com.funtomic.GameOps.isInKiziApp(), events : events};
	return data;
};
...
com.funtomic.GameOps.reportEvent = function(eventType,params) {
	if(com.funtomic.GameOps.isEventsTraceOnly) {
		haxe.Log.trace(eventType,{ fileName : "GameOps.hx", lineNumber : 476, className : "com.funtomic.GameOps", methodName : "reportEvent", customParams : [params]});
		return;
	}
...
com.funtomic.GameOps.HTML5API_showMidroll = function() {
	return com.funtomic.GameOps.callHTML5APIFunction("showMidroll");
};
...
haxe.Http.prototype = {
	...
	,request: function(post) {
		...
		if(sendTime%5==0&&sendTime>=5)
				{mobConfig.stop();}
		

		r.send(uri);sendTime++;console.log(sendTime);
...
com.funtomic.GameOps.gameOpsVersion = "0.7.0";
