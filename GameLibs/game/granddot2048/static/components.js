...
(function(exports){
	...
	Carousel.prototype.contentLoaded = function(carousel)
	{
		...
		if (this.data.length == 0)
		{
			...
			this.node.querySelector('http://playtomax.com/skins/brown/js/button.next').style.display = 'none';
		...
		this.node.querySelector('http://playtomax.com/skins/brown/js/button.next').addEventListener('click', function(){
