...
var flap = loadGameSound('static/flap.wav', 3);

var coin = loadGameSound('static/coin.wav', 1);

var punch = loadGameSound('static/punch.wav', 1);
...
wing.img = loadGameImage('static/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('static/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('static/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('static/gameover.png'); // 626 x 144
...
fbshare.showing = false;
fbshare.hiding = true;
fbshare.img = loadGameImage('static/fbshare.png');
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('static/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('static/clicktostart.png'); // 337 x 75
...
sndo.div.style.backgroundImage = 'url("static/soundoff.png")';
sndo.has_sound = true;
...
ground.bit = loadGameImage('static/ground.png');
