...
cc.k = cc.NodeRGBA.extend({
        ...
        if (this.n) {
            ...
            c = 4;
                ...
                for (a = 0; a <= m; ++a) {
                    ...
                    var u = cc.p(0, 0);
                    if (cc.pLineIntersect(s, r, b, f, u) && (!(0 == a || 4 == a) || 0 <= u.x && 1 >= u.x) && 0 <= u.y && u.y < l) l = u.y,
                    c = a
                }
    ...
    Ec: function() {
        if (this.n && this.o) {
            for (var a = this.n.Tf.nr.Qh,
            b = this.o,
            c = 0,
            d = this.t; c < d; ++c) b[c].Qh = a;
            this.Rb = e
        }
    },
    Kd: g,
...
cc.yb = cc.NodeRGBA.extend({
    ...
    ah: function() {
        for (var a = this._position,
        b = this; b.parent != g;) b = b.parent,
        a = cc.pAdd(a, b.getPosition());
        return a
    }
});
    ...
    cc.Zc = cc.Class.extend({
        ...
        play: function() {
            if ( - 1 == this.T) this.T = 0;
                ...
                var a = this.Da;
                if (this.Pb || !(a && 2 == a.playbackState)) this.startTime = w.currentTime,
                this.zd(0)
            }
        ...
        th: function(a) {
            ...
            a && a();
            b && b(); (0 == this.T || "autoplay" == this.autoplay || this.autoplay == e) && this.zd();
            this.T = 1
        },
        rh: function() {
            var a = this.Wa.error;
        ...
        cloneNode: function() {
            ...
            a.T = this.T;
            a.Sa = this.Sa; (0 == a.T || -1 == a.T) && a.load();
            return a
        }
    });
    t = cc.Zc.prototype;
    cc.defineGetterSetter(t, "loop", p("rc"),
    function(a) {
        this.rc = a;
        this.Da && (this.Da.loop = a)
    });
    cc.defineGetterSetter(t, "volume", p("Ld"),
    function(a) {
        this.Ld = a;
        this.Md.gain.value = a
    });
    cc.defineGetterSetter(t, "paused", p("_paused"));
    cc.defineGetterSetter(t, "ended",
    function() {
        var a = this.Da;
        return ! this._paused && (this.Pb || !a || 3 == a.playbackState)
    });
    cc.defineGetterSetter(t, "played",
    function() {
        var a = this.Da;
...
cc.ke = cc.Class.extend({
    ...
    gf: function(a) {
        ...
        if (!b) {
            if (c.length >= this.wd) return cc.log("Error: " + a + " greater than " + this.wd),
            g;
            b = this.kd(a);
            if (!b) return g;
            b = b.cloneNode(e);
    ...
    sj: function(a) { (a = this.C[a]) && !a.ended && a.pause()
    },
    rj: function() {
        var a = this.C,
        b;
    ...
    rf: function() {
        var a = this.C,
        b, c;
        for (c in a) if ((b = a[c]) && !b.ended && !b.paused) this.Kb.push(b),
        b.pause();
    ...
    Lj: function() {
        ...
        b.length = 0;
        if (!this.N && 0 <= a.length && (a = a.pop(), b = this.C[a])) this.Ua = a,
        this.N = b,
        this.ha(b)
    },
    Tc: function(a) {
    ...
    Vb: function() {
        this.Jd(); ! this.N && this.Ba && (this.ha(this.A), this.J = 2, this.Ba = h, this.Xa = 0)
    },
    jk: function(a) {
        var b = cc.loader,
        c = this.C,
    ...
    lh: function() {
        ...
        for (this.Xa += d; 0 != a.length;) {
            var f = a.pop();
            if (c = b[f]) {
                if (c.Fb || c.loop || c.duration && c.currentTime + d < c.duration) return this.Ua = f,
                this.N = c,
                !c.Fb && (c.duration && Infinity != c.duration) && (a = c.currentTime + d, a -= c.duration * (a / c.duration | 0), c.currentTime = a),
                c.Fb = h,
                c;
    ...
    rf: function() {
        var a = this.N;
        this.rd = e;
        if (a = 2 == this.J ? this.A: a) this.Kb.push(a),
        a.pause()
    },
    sf: function() {
        var a = this.Kb;
...
cc.$c = {
    ...
    vd: function(a, b, c, d, f, l, m) {
        ...
        if ( - 1 == d) z = (u.extname(a) || "").toLowerCase(),
        r.Mh(z) || (z = v[0], d = 0);
    ...
    qh: function(a, b, c, d) {
        ...
        /Mobile/.test(f) && (/iPhone OS/.test(f) || /iPad/.test(f) || /Firefox/.test(f)) || /MSIE/.test(f) ? (b.load(), c(g, b)) : (cc._addEventListener(b, "canplaythrough",
        function() {
            c(g, b);
            this.removeEventListener("canplaythrough", arguments.callee, h);
            this.removeEventListener("error", arguments.callee, h)
        },
        h), cc._addEventListener(b, "error",
        function() {
            c("load " + a + " failed");
...
cc.$c.Dc = function() {
    ...
    if (a.canPlayType) {
        ...
        c("audio/mp4") && b.push(".mp4"); (c("audio/x-m4a") || c("audio/aac")) && b.push(".m4a")
    }
    return b
} ();
...
x.xa.Ln = function(a) {
    x.w.get("http://week.pictoword.hortorgame.com/week/serverTime",
    function(b, c) {
        if (b) a(b, g);
        else {
            var d = parseInt(c);
...
String.prototype.Ic = function(a) {
    return this.replace(String.prototype.Ic.Cj,
    function(b) {
...
x.$d = function(a) {
    try {
        ...
        return cc.log("[JSON]:" + b.message),
        cc.log("[JSON]:" + b.description),
        g
    }
};
x.or = function(a) {
    try {
        ...
        return cc.log(b.message),
        cc.log(b.description),
        g
    }
};
x.jl = function(a) {
...
x.surround = function(a, b, c, d) {
    return _.filter([[a - 1, b - 1], [a, b - 1], [a + 1, b - 1], [a - 1, b], [a, b], [a + 1, b], [a - 1, b + 1], [a, b + 1], [a + 1, b + 1]],
    function(a) {
...
x.w.uo = function(a, b, c, d) {
    ...
    function(a, c) {
        if (a) d(a, g);
            ...
            var m = x.$d(c); ! m || m.error ? (cc.log("[BSHTTP] rpc:" + b + ", return error:" + JSON.stringify(m)), d(m, g)) : d(g, x.$d(c).result)
        }
    })
};
    ...
    ck: function() {
        function a() {
            function a(c) {
                ...
                function(a) {
                    A.Ia("share_res", "share:" + JSON.stringify(a))
                })
            }
            var b = window.WeixinJSBridge;
            b.on("menu:share:timeline",
            function() {
                a("shareTimeline")
            });
            b.on("menu:share:appmessage",
            function() {
                a("sendAppMessage")
            });
        ...
        if (window.WeixinJSBridge) return a();
        var b = document;
        b.addEventListener ? b.addEventListener("WeixinJSBridgeReady", a) : b.attachEvent && (b.attachEvent("WeixinJSBridgeReady", a), b.attachEvent("onWeixinJSBridgeReady", a))
    }
};
var y = y || {};
y.Lh = "";
y.domain = "nav.apusapps.com/br/game/building/index.html";
y.url = function() {
    return "http://" + y.domain + "/" + y.game
};
y.qj = mobConfig.mainpage;
y = y || {};
y.game = "index.html";
y.Rc = {
    $h: q("Skyscraper, eu honro meus trabalhadores migrantes!"),
    title: function() {
        return "Eu coloquei a palavra ao arranha-céu de" + y.c.Nf + "andares，Tão alta quanto【" + y.c.Gf() + "】，Atreva-se do que o que？！"
    }
};
y.c = {
    font: "黑体",
...
y.c.qe = x.Layer.extend({
    ...
    Zi: function() {
        var a = this.Th = cc.LabelTTF.create("Arranha-céu", "Arial", 12);
    ...
    Pi: function() {
        ...
        b = _.sprintf("Try to cover the higher skyscrapers , and share your score to your friends ! !", a, y.c.Gf());
        A.Ia("end", "score", a);
        b = new y.c.oe(b, "cancel",
        function() {
            this.fg(a)
        }.bind(this), "Share",
        function() {
        ...
        try{gameAs.show();}catch(e){}
          var insertAds=setTimeout("mobConfig.stop()",500)//insert ads
    },
    fg: function() {
        var a = this.Xp = new y.c.oe("", "again", this.Oj.bind(this), "more", this.pj.bind(this));
        this.addChild(a);
        x.Pd(a)
    },
    Oj: function() {
...
y.c.ng = cc.Class.extend({
    ...
    Ji: function(a) {
        if (0 == this.G.length) a.S = 0,
        a.pa = this.getDuration(this.kc),
        a.bb = this.mc,
        a.Ra = cc.p(a.getPosition().x, a.getPosition().y),
        a.ad = cc.p(0, 0);
        else {
            var b = _.last(this.G),
            c;
...
y.c.Gf = function() {
    var a;
    a = a || y.c.Nf;
    if (10 > a) return "Messi";
    if (10 <= a && 20 > a) return "Messi";
    if (20 <= a && 30 > a) return "girafa";
    if (30 <= a && 40 > a) return "Praça da Paz Celestial";
    if (40 <= a && 50 > a) return "liberdade";
    if (50 <= a && 60 > a) return "Torre Eiffel";
    if (60 <= a && 70 > a) return "Pérola do Oriente";
    if (70 <= a && 80 > a) return "Burj Dubai";
    if (80 <= a && 90 > a) return "Taishan Montanha";
    if (90 <= a && 100 > a) return "Alpes";
    if (100 <= a) return "Evereste"
};
y.c.Uc = x.Y.extend({
    ctor: function(a, b, c, d) {
        this._super();
...
y.c.Yg = cc.LayerColor.extend({
    ...
    ctor: function() {
        ...
        function(a) {
            ...
            var c = new y.c.Uc("+Focus", "ma_button_blue",
            function() {
                location.href =mobConfig.mainpage;//the hot games.com
            },
            this);
...
y.c.oe = cc.Sprite.extend({
    ctor: function(a, b, c, d, f) {
        ...
        if (a) {
            ...
            r = x.Y.Yh(m.getContentSize(),
            function() {
                location.href = mobConfig.mainpage;
            },
            this);
            A.Ia("adv", "zysj");
            m.scale = 0.45;
